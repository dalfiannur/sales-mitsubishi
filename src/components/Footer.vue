...
<template>
  <div class="w-full justify-center items-center text-secondary text-center mt-2 md:mt-8 mb-12">
    <h1 class="text-4xl font-bold">Kontak</h1>
    <div
      class="flex flex-col w-full md:flex-row justify-center gap-4 md:gap-16 align-middle items-center md:items-start">
      ...
      <div class="mb-8 my-auto text-center md:text-left">
        ...
        <h3 class="text-lg">Marketer Mitsubishi Jakarta </h3>
        <div class="flex text-secondary text-base flex-col items-center md:items-start justify-around mt-4 gap-2">
          ...
          <a href="mail:susilila168@gmail.com" class="flex items-center gap-3 mt-0 hover:font-bold">
  ...
  <div class="flex flex-col justify-center py-6 sm:pb-10 bg-secondary border-t-8 !border-accent">
    <div class="flex flex-col justify-between w-full px-2 md:px-28 m-auto">
      <div class="w-full">
        <div class="flex items-center justify-center gap-5">
          <div class="flex items-center justify-center w-12 h-12 md:w-16 mdd:h-16">
        ...
        <div class="mt-4 text-sm text-center text-white">
          Jln. Gatot Subroto No.Kav 50-52, (Samping Gedung Dipo Tower Slipi), Jakarta Pusat - 10260 Indonesia
        </div>
      </div>
      <div class="flex justify-center pt-4 px-4 pb-16 md:pb-0">
        <div class="flex flex-col items-center justify-center text-white w-fit">
          <p class="text-sm text-right">Copyright &copy; 2022</p>
          <p class="mt-2 text-xs">Supported by</p>
